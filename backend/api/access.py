...
# Порядок и группы держим синхронными с сайдбаром: админка
...
SHARED_PREFIXES: tuple[str, ...] = (
    "/api/auth/logout/",
    "/api/auth/me/",
    # Кнопка «Обновить» есть на каждой странице, поэтому и доступна каждому
    # вошедшему. Опасность здесь не в правах, а в частоте: расход общий
