...
class Stock(DomainModel):
    ...
    # Сколько дней товар лежит без движения. Считает МойСклад, мы забираем
    # готовым — это основа для «Порога закупки».
    stock_days = models.IntegerField("Дней без движения", null=True, blank=True)
