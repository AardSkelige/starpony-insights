 ...
 * `primary`, а не `--chart-1`. Причина не во вкусе: тёмные шаги палитры
 * графиков в проекте пока совпадают со светлыми, а `primary` честно
 * меняется между темами (`DESIGN.md` §1, «Графики»).
 *
