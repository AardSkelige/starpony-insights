 ...
 *
 * **Минус на единице снимает отметку.** Ноль в партии — строка, которая
 * ни на что не влияет, и объяснять человеку, чем она отличается
 * от неотмеченной, пришлось бы словами.
 */
