 ...
 *
 * Экспортируется с тех пор, как понадобился второму форматтеру — оценке
 * на главной. Литералом его писать нельзя: линтер не пропускает символ,
 * неотличимый от обычного пробела, и это верное правило.
 */
export const NBSP = "\u00a0"
