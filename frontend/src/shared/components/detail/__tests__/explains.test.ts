...
const INLINE_EXPLAINED: Record<string, string[]> = {
  home: [
    // Упущенное и замороженное: оба числа считаются из двух источников
    // сразу, и без формулы проверить их негде.
    "Деньги лежат не там",
    // Маржа: (выручка − себестоимость) ÷ выручка по отчёту прибыльности.
    "Где зарабатываем",
    // Разница выручки месяцев, с товарами, появившимися и исчезнувшими.
