...
export function AppShell({ profile }: { profile: Profile }) {
  // Ширина живёт в браузере. `DESIGN.md` §4 требует хранить её за пользователем
  // в базе, чтобы переживала смену браузера, — это появится вместе с моделью
  // настроек, там же, где закрепы «Избранного».
